  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "flex",
        weekday:
          "text-slate-500 rounded-md w-9 font-normal text-[0.8rem] dark:text-slate-400 text-center flex items-center justify-center",
        ...
        day_button: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 aria-selected:bg-slate-900 aria-selected:text-slate-50 aria-selected:hover:bg-slate-900 aria-selected:hover:text-slate-50 dark:aria-selected:bg-slate-50 dark:aria-selected:text-slate-900 dark:aria-selected:hover:bg-slate-50 dark:aria-selected:hover:text-slate-900"
        ),
        range_end: "day-range-end",
        selected: "font-semibold",
        today: "text-blue-600 font-semibold dark:text-blue-400",
        outside:
